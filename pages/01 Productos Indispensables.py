...
df_indispensables_print.to_excel(f"{BASE_DIR / 'data/out/productos_indispensables_{hoy}.xlsx'}")

st.markdown('**Descargue un archivo Excel con la lista de Productos Indispensables:**')
with open(f"{BASE_DIR / 'data/out/productos_indispensables_{hoy}.xlsx'}", 'rb') as xlsx:
    st.download_button(
